...
import tqdm
import logging
from u2net.libs.strings import *
from u2net.libs.networks import model_detect
...
def cli(input_path, output_path, model_name):
    """CLI"""
    ...
    if wmode == "file":  # File work mode
        image, mask = model.process_image(input_path)
